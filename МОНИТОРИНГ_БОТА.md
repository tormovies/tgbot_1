...
Каталог бота на **website.com.ru** (пример): `/home/admin/domains/website.com.ru/public_html/tgbot98` — подставь своё имя папки, если другое.
...
Имя файла сервиса произвольное, ниже пример `tgbot98.service`:
...
```ini
[Unit]
Description=Telegram dream bot (website.com.ru /tgbot98)
